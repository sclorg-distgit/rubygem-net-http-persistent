...
Patch1:		rubygem-net-http-persistent-2.8-Updated-test-RSA-key-size-to-1024-bits.patch
...
%changelog
* Fri Nov 15 2013 Vít Ondruch <vondruch@redhat.com> - 2.7-3
- Fix test suite running against OpenSSL 1.0.1+.
